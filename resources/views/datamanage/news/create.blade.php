...
@section('content')
    <div class="max-w-4xl mx-auto animate-fadeIn">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3 text-xs font-medium text-slate-500">
                        <li class="inline-flex items-center">
                            <a href="{{ route('backend.welcomedatamanage') }}"
                                class="hover:text-red-600 transition-colors">แผงควบคุม</a>
                        </li>
                        <li>
                            <div class="flex items-center">
                                <i class="fa-solid fa-chevron-right mx-2 text-[10px] opacity-50"></i>
                                <a href="{{ route('datamanage.news.index') }}"
                                    class="hover:text-red-600 transition-colors">จัดการข่าวสาร</a>
                            </div>
                        </li>
                        <li aria-current="page">
                            <div class="flex items-center">
                                <i class="fa-solid fa-chevron-right mx-2 text-[10px] opacity-50"></i>
                                <span class="text-slate-400">เพิ่มข่าวสารใหม่</span>
                            </div>
                        </li>
                    </ol>
                </nav>
        ...
        <!-- Main Card -->
        <div
            class="bg-white dark:bg-kumwell-card p-8 md:p-12 rounded-[2rem] shadow-[0_25px_70px_-15px_rgba(0,0,0,0.1)] border border-white dark:border-gray-800 transition-all hover:shadow-[0_30px_80px_-10px_rgba(0,0,0,0.15)] relative overflow-hidden group">
            <!-- Decorative blob -->
            <div
                class="absolute -top-12 -right-12 w-48 h-48 bg-red-50/50 rounded-full blur-3xl group-hover:bg-red-100/40 transition-colors -z-0">
            </div>
