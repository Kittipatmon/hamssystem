...
@section('content')
    <div class="min-h-screen bg-gray-50 dark:bg-slate-900 pb-20">
        ...
        <div id="hero-section" class="relative h-64 md:h-80 overflow-hidden bg-[#4A0E10]">
            ...
            <div
                class="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] text-white">
            </div>
            ...
            <div class="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <svg class="absolute inset-0 w-full h-full opacity-20" preserveAspectRatio="none">
                    ...
                    <path class="animate-flow-line" d="M -100 100 Q 200 50 500 100 T 1100 100" stroke="url(#lineGradient)"
                        stroke-width="2" fill="none" />
                    <path class="animate-flow-line-delayed" d="M -100 150 Q 300 100 600 150 T 1200 150"
                        stroke="url(#lineGradient)" stroke-width="1" fill="none" />
                </svg>
                ...
                <div class="absolute inset-0">
                    @for ($i = 0; $i < 12; $i++)
                        <div class="sparkle absolute w-1 h-1 bg-white rounded-full opacity-0 animate-twinkle"
                            style="top: {{ rand(5, 95) }}%; left: {{ rand(5, 95) }}%; animation-delay: {{ rand(0, 8000) }}ms;">
                        </div>
                    @endfor
                </div>

                <!-- Floating Orbs -->
                <div class="parallax-element absolute top-[10%] left-[10%] w-64 h-64 bg-white/10 rounded-full blur-[80px] animate-float-slow"
                    data-speed="0.02"></div>
                <div class="parallax-element absolute bottom-[20%] right-[15%] w-80 h-80 bg-black/20 rounded-full blur-[100px] animate-pulse-slow"
                    data-speed="-0.03"></div>
                <div class="parallax-element absolute top-[40%] right-[10%] w-48 h-48 bg-kumwell-red/20 rounded-full blur-[60px] animate-float-delayed"
                    data-speed="0.04"></div>
                ...
                <div class="absolute inset-0 opacity-30" id="particles-container">
                    @for ($i = 0; $i < 20; $i++)
                        <div class="particle absolute bg-white rounded-full opacity-0 animate-stardust"
                            style="width: {{ rand(1, 2) }}px; height: {{ rand(1, 2) }}px; top: {{ rand(0, 100) }}%; left: {{ rand(0, 100) }}%; animation-delay: {{ rand(0, 5000) }}ms;">
                        </div>
                    @endfor
                </div>
            </div>
            ...
            <style>
                ...
                .animate-stardust {
                    animation: stardust 5s linear infinite;
                }
        ...
        <div class="max-w-6xl mx-auto px-6 -mt-32 relative z-10">
            <!-- Header Card -->
            <div
                class="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-[2.5rem] p-8 md:p-12 shadow-2xl border border-white/20 dark:border-slate-700/50 mb-8">
                <div class="flex flex-col md:flex-row items-center md:items-end gap-8">
                    ...
                    <div class="relative group">
                        <div id="avatar-container"
                            ...
                            @else
                                <div id="profile-placeholder"
                                    class="w-full h-full bg-gradient-to-br from-gray-100 to-gray-200 dark:from-slate-700 dark:to-slate-600 flex items-center justify-center text-gray-400 dark:text-slate-500">
                        ...
                        <label for="{{ $inputId }}"
                            class="absolute bottom-4 right-4 bg-white dark:bg-slate-700 w-12 h-12 rounded-2xl shadow-xl flex items-center justify-center cursor-pointer hover:bg-kumwell-red hover:text-white transition-all transform hover:rotate-12 z-20">
                    ...
                    <div class="flex-1 flex flex-col items-center md:items-start space-y-4 text-center md:text-left">
                        <div class="space-y-1">
                            <span
                                class="inline-block px-4 py-1.5 rounded-full bg-kumwell-red/10 text-kumwell-red text-xs font-black uppercase tracking-widest border border-kumwell-red/20">
                        ...
                        <div
                            ...
                            <div
                                class="flex items-center gap-2 px-4 py-2 bg-green-500/10 text-green-600 border border-green-500/20 rounded-xl">
                        ...
                        <div class="lg:hidden w-full pt-4">
                            <a href="#"
                                class="w-full text-center bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-8 py-4 rounded-3xl font-black text-sm uppercase tracking-widest active:scale-95 transition-all shadow-xl shadow-gray-400/20 dark:shadow-none inline-block">
                                Edit Profile
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="hidden lg:block pb-4">
                        <a href="#"
                            class="bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-8 py-4 rounded-3xl font-black text-sm uppercase tracking-widest hover:scale-105 transition-all shadow-xl shadow-gray-400/20 dark:shadow-none inline-block">
                            Edit Profile
                        </a>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-4 space-y-8">
                    ...
                    <div
                        class="bg-white dark:bg-slate-800 rounded-[2rem] p-8 shadow-sm border border-gray-100 dark:border-slate-700">
                        <h3
                            class="text-xl font-black text-gray-900 dark:text-white mb-8 border-b border-gray-50 dark:border-slate-700 pb-4 flex items-center gap-3">
                        ...
                        <div class="space-y-10">
                            <div class="text-center">
                                ...
                                <div class="text-xs font-bold text-gray-400 uppercase tracking-widest mt-1">Years in Service
                                </div>
                            </div>
                            ...
                            <div class="space-y-6 pt-6 border-t border-gray-50 dark:border-slate-700">
                                <div class="flex items-center gap-4">
                                    <div
                                        class="w-12 h-12 rounded-2xl bg-blue-50 dark:bg-blue-500/10 flex items-center justify-center text-blue-500">
                                        <i class="fa-solid fa-calendar-check"></i>
                                    </div>
                                    <div class="flex-1">
                                        <p class="text-xs font-bold text-gray-400 uppercase tracking-[0.05em]">Started Date
                                        </p>
                                ...
                                <div class="flex items-center gap-4">
                                    <div
                                        class="w-12 h-12 rounded-2xl bg-orange-50 dark:bg-orange-500/10 flex items-center justify-center text-orange-500">
                                        <i class="fa-solid fa-hourglass-half"></i>
                                    </div>
                                    <div class="flex-1">
                                        <p class="text-xs font-bold text-gray-400 uppercase tracking-[0.05em]">Current
                                            Status</p>
                                        <p class="text-sm font-black text-gray-800 dark:text-gray-200">{{ $totalMonths }}
                                            Months employed</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="lg:col-span-8 space-y-8">
                    ...
                    <div class="flex gap-10 border-b border-gray-200 dark:border-slate-700 px-4">
                        <button
                            class="pb-4 text-sm font-black uppercase tracking-widest text-kumwell-red border-b-4 border-kumwell-red">Information</button>
                        <button
                            class="pb-4 text-sm font-black uppercase tracking-widest text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">Career
                            Path</button>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <!-- Personal Info -->
                        <div
                            class="bg-white dark:bg-slate-800 rounded-[2rem] p-8 shadow-sm border border-gray-100 dark:border-slate-700 transition-all hover:border-kumwell-red/30">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="group">
                                    <label
                                        class="text-[10px] font-bold text-gray-400 uppercase tracking-widest block mb-1">Gender</label>
                                    <p class="text-sm font-bold text-gray-800 dark:text-gray-200">
                                        {{ $user->sex ?? 'Not Specified' }}</p>
                                </div>
                                <div class="group">
                                    <label
                                        class="text-[10px] font-bold text-gray-400 uppercase tracking-widest block mb-1">Employee
                                        Type</label>
                                    <p class="text-sm font-bold text-gray-800 dark:text-gray-200">
                                        {{ $user->employee_type ?? 'Permanent' }}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        class="bg-gray-50 dark:bg-slate-800/40 rounded-[2.5rem] p-10 border-2 border-dashed border-gray-200 dark:border-slate-700">
                        <div class="flex flex-col md:flex-row items-center gap-8">
                            <div
                                class="w-20 h-20 rounded-full bg-white dark:bg-slate-700 shadow-xl flex items-center justify-center">
                                <i class="fa-solid fa-shield-halved text-kumwell-red text-3xl"></i>
                            </div>
                            <div class="flex-1 text-center md:text-left">
                                <h5 class="text-lg font-black text-gray-900 dark:text-white mb-2">Corporate Classification
                                </h5>
                                <p class="text-sm text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
                                    Current HR Level: <span
                                        class="text-kumwell-red font-black">{{ $user->hr_level ?? 'Standard' }}</span>.
