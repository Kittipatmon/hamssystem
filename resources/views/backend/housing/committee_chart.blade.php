                            ...
                            <div class="level-container">
                                ...
                                @if($loop->first)
                                    <div class="role-header flex items-center gap-2">
                                        ...
                                        @if($isHams)
                                            <button onclick="openAddModal('{{ $role }}')" class="level-add-btn w-8 h-8 rounded-xl bg-emerald-500 text-white shadow-lg hover:rotate-90 flex items-center justify-center transition-all" title="เพิ่มในสายนี้">
