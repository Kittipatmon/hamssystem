    ...
    <div class="max-w-7xl mx-auto px-4 md:px-6">
        <div class="h-16 flex items-center justify-between">
            ...
            <div class="hidden lg:flex items-center gap-2 lg:gap-3">
                            ...
                            <li class="px-4 py-3 border-b border-slate-100 mb-0 bg-slate-50/50 rounded-t-2xl">
                             ...
                             <li>
                                <a href="{{ route('profileUser') }}"
                                    ...
                                    <i class="fa-regular fa-id-badge {{ request()->routeIs('profileUser') ? 'text-red-600' : 'text-red-400' }} w-4 text-center"></i> โปรไฟล์
                                </a>
                            </li>
                            <li>
                                <a href="#"
                    ...
                    <div tabindex="0" class="dropdown-content menu bg-white rounded-2xl mt-2 p-0 w-80 sm:w-96 shadow-2xl border border-slate-100 gap-0 animate-fadeIn z-[110] overflow-hidden">
                        ...
                        <div class="flex items-center justify-between px-4 py-3 bg-slate-50/80 border-b border-slate-100">
                            <div class="flex items-center gap-2">
                                <span class="font-bold text-slate-800 text-[15px]">การแจ้งเตือนข่าวสาร</span>
                            </div>
                        ...
                        <div class="max-h-[320px] overflow-y-auto divide-y divide-slate-100 custom-scrollbar">
                            ...
                            @empty
                                <div class="py-8 text-center px-4">
                                    ...
                                    <p class="text-[11px] text-slate-400 mt-0.5">ระบบจะแสดงการแจ้งเตือนเมื่อมีข่าวสารหรืออัปเดตใหม่</p>
                                </div>
                            @endforelse
                        </div>
                        ...
                        <div class="p-3 bg-slate-50/50 border-t border-slate-100">
                            <button type="button" onclick="document.getElementById('all_notif_modal_data').showModal();" class="flex items-center justify-center w-full py-2.5 px-4 bg-red-600 hover:bg-red-700 text-white font-bold text-xs rounded-xl shadow-md shadow-red-200 transition-all cursor-pointer">
                ...
                <dialog id="all_notif_modal_data" class="modal modal-bottom sm:modal-middle z-[200]">
                    <div class="modal-box bg-white rounded-3xl p-0 max-w-2xl overflow-hidden shadow-2xl border border-slate-100 text-left">
                        ...
                        <div class="flex items-center justify-between px-6 py-4 bg-gradient-to-r from-red-600 to-red-700 text-white">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 class="font-black text-lg leading-tight">การแจ้งเตือนข่าวสารองค์กร</h3>
                                    <p class="text-xs text-red-100 font-medium">รวมข่าวสารองค์กรและประกาศอัปเดตระบบ</p>
                                </div>
                            </div>
                            <form method="dialog">
                        ...
                        <div class="p-6 max-h-[60vh] overflow-y-auto divide-y divide-slate-100 custom-scrollbar">
                            ...
                            @empty
                                <div class="py-12 text-center">
                                    ...
                                    <h4 class="text-sm font-bold text-slate-700">ไม่มีข่าวสารใหม่ในขณะนี้</h4>
                                    <p class="text-xs text-slate-400 mt-1">ติดตามข่าวสารอัปเดตขององค์กรได้จากหมวดข่าวสาร</p>
                                </div>
                            @endforelse
                        </div>
                        ...
                        <div class="px-6 py-4 bg-slate-50 border-t border-slate-100 flex justify-between items-center">
                            <span class="text-xs text-slate-500 font-medium">รวมข่าวสาร {{ $notifCount }} รายการ</span>
                            <form method="dialog">
                    ...
                    <details class="group [&_summary::-webkit-details-marker]:hidden">
                        ...
                        <div class="mt-1 mb-2 ml-4 pl-4 border-l-2 border-red-100 flex flex-col gap-1">
                            <a href="{{ route('datamanage.news.index') }}"
                                ...
                                <i class="fa-regular fa-newspaper text-red-400 w-4 text-center"></i> ข้อมูลข่าวสาร
                            </a>
                        </div>
                    </details>
                @endif
