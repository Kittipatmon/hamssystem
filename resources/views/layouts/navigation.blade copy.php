                ...
                <div class="dropdown dropdown-end">
                    ...
                    <ul tabindex="0"
                     ...
                     shadow-[0_10px_30px_-12px_rgba(0,0,0,.25)] border border-slate-200">
                        <li><a href="#" class="text-[13px] pill"><i class="fa-regular fa-building"></i> ข้อมูลบริษัท</a></li>
                        <li><a href="#" class="text-[13px] pill"><i class="fa-solid fa-users"></i> ทีมงาน</a></li>
                        <li><a href="{{ route('datamanage.news.newsalllist') }}" class="text-[13px] pill"><i class="fa-regular fa-newspaper"></i> ข่าวสาร</a></li>
                    </ul>
                </div>
            ...
            <div class="flex flex-col gap-2">
                ...
                <details class="collapse bg-transparent">
                    ...
                    <div class="mt-2 ms-2 flex flex-col gap-1">
                        <a href="#" class="text-[13px] px-3 py-1 rounded-lg hover:bg-red-50"><i class="fa-regular fa-building"></i> ข้อมูลบริษัท</a>
                        <a href="#" class="text-[13px] px-3 py-1 rounded-lg hover:bg-red-50"><i class="fa-solid fa-users"></i> ทีมงาน</a>
                        <a href="{{ route('datamanage.news.newsalllist') }}" class="text-[13px] px-3 py-1 rounded-lg hover:bg-red-50"><i class="fa-regular fa-newspaper"></i> ข่าวสาร</a>
                    </div>
                </details>
