<div class="flex items-center justify-center">
    <div class="w-full max-w-md bg-white rounded-xl shadow-lg ring-1 ring-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-800" id="addItemsStockTypeModalLabel">เพิ่ม stock อุปกรณ์</h2>
        </div>
        <div class="px-6 py-5">
            <form action="{{ route('items.updateStock', $item->item_id) }}" method="POST" class="space-y-5">
                @csrf
                <div>
