...
@section('content')
    <div class="max-w-[1600px] mx-auto px-4 py-8 space-y-8 uppercase tracking-tight">
        ...
        <div id="filter-section"
            class="bg-slate-800 p-8 rounded-[2.5rem] shadow-xl border border-slate-700 hidden animate-zoom-in">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex bg-slate-100 p-1 rounded-xl">
                        ...
                        <button id="view-grid-btn"
                            class="p-2 px-4 rounded-lg text-slate-400 hover:text-slate-600 transition-all">
            ...
            <div class="p-4 md:p-8">
                ...
                <div id="mobile-view" class="hidden">
                    <div class="grid grid-cols-1 gap-4">
                        @foreach ($requisitions as $req)
                            <div
                                class="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm space-y-5 animate-zoom-in">
                                <div class="flex items-center justify-between">
                                    <span
                                        class="px-3 py-1 bg-slate-100 text-slate-600 rounded-lg font-black font-mono text-xs">{{ $req->requisitions_code }}</span>
                                    <span
                                        class="{{ $req->packing_status_class }} text-[9px] font-black uppercase px-3 py-1 rounded-full shadow-sm">
                                        {{ $req->packing_status_label }}
                                    </span>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4 pt-4 border-t border-slate-50">
                                    <div>
                                        <p class="text-[9px] font-black text-slate-300 uppercase tracking-widest font-mono">DATE
                                        </p>
                                        <p class="text-[14px] font-black text-slate-600">
                                            {{ optional($req->request_date)->format('d / m / Y') }}</p>
                                    </div>
                                    <div class="text-right">
                                        <p class="text-[9px] font-black text-slate-300 uppercase tracking-widest font-mono">
                                            TOTAL VALUE</p>
                                        <p class="text-[15px] font-black text-red-600 font-mono">
                                            ฿{{ number_format((float) ($req->total_price ?? 0), 2) }}</p>
                                    </div>
                                </div>
