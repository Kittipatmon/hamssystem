...
@section('content')
    <style>
        ...
        /* Section Header Hover Effect: Bottom Underline Slide Right */
        .header-hover {
            position: relative;
            cursor: default;
            display: inline-flex;
    ...
    <div class="-mx-6 -mt-6 mb-8">
            ...
            <div class="absolute inset-0 flex flex-col justify-center px-8 sm:px-12 lg:px-20 max-w-7xl mx-auto w-full z-20">
                <div class="max-w-2xl animate-fade-in-up">
                    ...
                    <h1
                        ...
                        <span class="text-red-200">Management</span>
                    ...
                    {{-- Subtitle --}}
                    <p
                        class="text-white/80 text-base sm:text-lg leading-relaxed max-w-xl font-medium drop-shadow-md border-l border-white/20 pl-4 py-1">
        ...
        {{-- Scroll Indicator --}}
        <div class="absolute bottom-20 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/50 hover:text-white transition-colors duration-300 z-20 cursor-pointer lg:center"
                ...
                <div class="flex items-center gap-4 group">
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute -bottom-2 left-0 w-full h-1 bg-blue-600/10 rounded-full overflow-hidden">
                            <div class="w-full h-full bg-blue-600 rounded-full origin-left transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 ease-out"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="flex flex-col md:flex-row min-h-[400px]">
                        ...
                        <div id="modalImageContainer" class="w-full md:w-[48%] h-80 md:h-auto overflow-hidden bg-zinc-50 hidden border-r border-zinc-100">
                            <img id="modalImage" src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1 1'%3E%3C/svg%3E" class="w-full h-full object-cover" alt="Announcement">
                        </div>
